...
pub fn lexerdef() -> LRNonStreamingLexerDef<lrlex::lexemes::DefaultLexeme, u32> {
    let rules = vec![
        ...
        Rule::new(Some(4), Some("COLON".to_string()), "\":\"".to_string()).unwrap(),
        ...
        Rule::new(Some(5), Some("LEFTBRACKET".to_string()), "\\{".to_string()).unwrap(),
        Rule::new(Some(6), Some("RIGTHBRACKET".to_string()), "\\}".to_string()).unwrap(),
        Rule::new(Some(13), Some("COMMA".to_string()), "\",\"".to_string()).unwrap(),
        Rule::new(Some(11), Some("EQUALSIGN".to_string()), "\"=\"".to_string()).unwrap(),
        ...
        Rule::new(Some(12), Some("PRINT".to_string()), "\"print\"".to_string()).unwrap(),
        Rule::new(Some(8), Some("LEFTPARENTHESES".to_string()), "\\(".to_string()).unwrap(),
        Rule::new(Some(9), Some("RIGHTPARENTHESES".to_string()), "\\)".to_string()).unwrap(),
        Rule::new(Some(7), Some("IF".to_string()), "\"if\"".to_string()).unwrap(),
        Rule::new(Some(10), Some("ELSE".to_string()), "\"else\"".to_string()).unwrap(),
        ...
        Rule::new(Some(26), None, "[\\t ]+".to_string()).unwrap(),
    ];
...
#[allow(dead_code)]
pub const T_RIGHTPARENTHESES: u32 = 9;
#[allow(dead_code)]
pub const T_PRINT: u32 = 12;
#[allow(dead_code)]
...
#[allow(dead_code)]
pub const T_ELSE: u32 = 10;
#[allow(dead_code)]
pub const T_LEFTPARENTHESES: u32 = 8;
#[allow(dead_code)]
...
#[allow(dead_code)]
pub const T_EQUALSIGN: u32 = 11;
#[allow(dead_code)]
pub const T_LEFTBRACKET: u32 = 5;
#[allow(dead_code)]
...
#[allow(dead_code)]
pub const T_RIGTHBRACKET: u32 = 6;
#[allow(dead_code)]
pub const T_IF: u32 = 7;
#[allow(dead_code)]
pub const T_COLON: u32 = 4;
#[allow(dead_code)]
pub const T_COMMA: u32 = 13;
}